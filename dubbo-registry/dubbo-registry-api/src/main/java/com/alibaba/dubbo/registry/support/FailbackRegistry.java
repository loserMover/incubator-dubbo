...
public abstract class  FailbackRegistry extends AbstractRegistry {
    ...
    /**
     * @desc 失败重试定时器，定时检查是否请求失败，如果有，无限次重试
     */
    ...
    /**
     * @desc 将监听器添加到‘failedSubscribed’中
     * @param url URL对象
     * @param listener 监听器
     */
    ...
    /**
     * @desc //移除出‘failedSubscribed’，‘failedUnsubscribed’，‘failedNotified’变量
     * @param url url对象
     * @param listener 监听器
     */
    ...
    public void register(URL url) {
        //添加到‘registered’变量
        super.register(url);
        //移除出‘failedRegistered’和‘failedUnregistered’变量
        ...
        try {
            ...
            //将失败的注册请求记录添加到‘failedRegistered’，定时重试
    ...
    public void unregister(URL url) {
        ...
        try {
            ...
            //将注册失败的请求记录添加‘failedUnregistered’变量
            // Record a failed registration request to a failed list, retry regularly
    ...
    public void subscribe(URL url, NotifyListener listener) {
        ...
        //移除出‘failedSubscribed’，‘failedUnsubscribed’，‘failedNotified’变量
        ...
        try {
            ...
            Throwable t = e;
            //如果有缓存的URL集合，进行通知。后续订阅成功后，会使用最新的URL集合，进行通知。
            ...
            //将失败的请阅请求添加到‘failedSubscribed’变量，定时重试
            // Record a failed registration request to a failed list, retry regularly
    ...
    public void unsubscribe(URL url, NotifyListener listener) {
        ...
        try {
            ...
            //将失败的取消订阅请求添加到‘failedUnsubcribed’，定时重试
            // Record a failed registration request to a failed list, retry regularly
    ...
    protected void recover() throws Exception {
        // register 恢复注册，添加到‘failedRegistered’，定是重试
